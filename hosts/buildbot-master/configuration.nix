{
  ...
  services.buildbot-master = {
    ...
    masterCfg = ''
      ...
      worker_password = open("${config.age.secrets.buildbot-worker-password.path}").read().strip()
      c["workers"] = [
      ...
      db_password = open("${config.age.secrets.buildbot-db-password.path}").read().strip()
      c["secretsProviders"] = [
          secrets.SecretInAFile(dirname="${config.services.buildbot-master.buildbotDir}/secrets"),
      ]
